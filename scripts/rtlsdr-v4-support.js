(function () { function r(e, n, t) { function o(i, f) { if (!n[i]) { if (!e[i]) { var c = "function" == typeof require && require; if (!f && c) return c(i, !0); if (u) return u(i, !0); var a = new Error("Cannot find module '" + i + "'"); throw a.code = "MODULE_NOT_FOUND", a } var p = n[i] = { exports: {} }; e[i][0].call(p.exports, function (r) { var n = e[i][1][r]; return o(n || r) }, p, p.exports, r, e, n, t) } return n[i].exports } for (var u = "function" == typeof require && require, i = 0; i < t.length; i++)o(t[i]); return o } return r })()({
  1: [function (require, module, exports) {
    ...
    /**
     * Operations on the R820T/R828D tuner chips.
     * @param {RtlCom} com The RTL communications object.
     * @param {number} xtalFreq The frequency of the oscillator crystal.
     * @param {number} i2cAddr The I2C address (0x34 for R820T, 0x74 for R828D).
     * @constructor
     */
    function R82xTuner(com, xtalFreq, i2cAddr) {

      /**
       * I2C address for this tuner instance.
       */
      var I2C_ADDR = i2cAddr || 0x34;
      ...
      async function initRegisters(regs) {
        ...
        for (var i = 0; i < regs.length; ++i) {
          cmds.push([CMD.I2CREG, I2C_ADDR, i + 5, regs[i]]);
        }
      ...
      async function readRegBuffer(addr, length) {
        var data = await com.i2c.readRegBuffer(I2C_ADDR, addr, length);
      ...
      async function writeRegMask(addr, value, mask) {
        ...
        await com.i2c.writeRegister(I2C_ADDR, addr, val);
      }
    ...
    /**
     * Checks if the R820T/R828D tuner is present.
     * @param {RtlCom} com The RTL communications object.
     * @param {number} i2cAddr The I2C address to check (0x34 for R820T, 0x74 for R828D).
     * @return {boolean} A boolean that tells whether the tuner is present.
     */
    R82xTuner.check = async function (com, i2cAddr) {
      var data = await com.i2c.readRegister(i2cAddr || 0x34, 0);
      return (data == 0x69);
    };

    module.exports = R82xTuner;
